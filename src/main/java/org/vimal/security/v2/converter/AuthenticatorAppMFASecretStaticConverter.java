...
@Component
public class AuthenticatorAppMFASecretStaticConverter {
    private final AESStaticUtility aesStaticUtility;

    public AuthenticatorAppMFASecretStaticConverter(PropertiesConfig propertiesConfig,
                                                    ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesStaticUtility = new AESStaticUtility(propertiesConfig.getAuthenticatorAppMfaSecretStatic(), objectMapper);
    }
