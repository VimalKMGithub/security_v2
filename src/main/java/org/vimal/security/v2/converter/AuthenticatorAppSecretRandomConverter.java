...
@Component
public class AuthenticatorAppSecretRandomConverter {
    private final AESRandomUtility aesRandomUtility;

    public AuthenticatorAppSecretRandomConverter(PropertiesConfig propertiesConfig,
                                                 ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesRandomUtility = new AESRandomUtility(propertiesConfig.getAuthenticatorAppSecretRandom(), objectMapper);
    }
