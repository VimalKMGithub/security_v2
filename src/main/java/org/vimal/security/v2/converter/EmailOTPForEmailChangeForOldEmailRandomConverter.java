...
@Component
public class EmailOTPForEmailChangeForOldEmailRandomConverter {
    private final AESRandomUtility aesRandomUtility;

    public EmailOTPForEmailChangeForOldEmailRandomConverter(PropertiesConfig propertiesConfig,
                                                            ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesRandomUtility = new AESRandomUtility(propertiesConfig.getEmailOtpForEmailChangeForOldEmailSecretRandom(), objectMapper);
    }
