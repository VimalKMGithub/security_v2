...
@Component
public class EmailOTPForEmailChangeRandomConverter {
    private final AESRandomUtility aesRandomUtility;

    public EmailOTPForEmailChangeRandomConverter(PropertiesConfig propertiesConfig,
                                                 ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesRandomUtility = new AESRandomUtility(propertiesConfig.getEmailOtpForEmailChangeSecretRandom(), objectMapper);
    }
