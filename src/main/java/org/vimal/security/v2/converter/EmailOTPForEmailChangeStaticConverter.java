...
@Component
public class EmailOTPForEmailChangeStaticConverter {
    private final AESStaticUtility aesStaticUtility;

    public EmailOTPForEmailChangeStaticConverter(PropertiesConfig propertiesConfig,
                                                 ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesStaticUtility = new AESStaticUtility(propertiesConfig.getEmailOtpForEmailChangeSecretStatic(), objectMapper);
    }
