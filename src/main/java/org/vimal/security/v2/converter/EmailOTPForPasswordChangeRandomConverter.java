...
@Component
public class EmailOTPForPasswordChangeRandomConverter {
    private final AESRandomUtility aesRandomUtility;

    public EmailOTPForPasswordChangeRandomConverter(PropertiesConfig propertiesConfig,
                                                    ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesRandomUtility = new AESRandomUtility(propertiesConfig.getEmailOtpForPasswordChangeSecretRandom(), objectMapper);
    }
