...
@Component
public class EmailOTPForPasswordChangeStaticConverter {
    private final AESStaticUtility aesStaticUtility;

    public EmailOTPForPasswordChangeStaticConverter(PropertiesConfig propertiesConfig,
                                                    ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesStaticUtility = new AESStaticUtility(propertiesConfig.getEmailOtpForPasswordChangeSecretStatic(), objectMapper);
    }
