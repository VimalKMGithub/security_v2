...
@Component
public class EmailOTPRandomConverter {
    private final AESRandomUtility aesRandomUtility;

    public EmailOTPRandomConverter(PropertiesConfig propertiesConfig,
                                   ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesRandomUtility = new AESRandomUtility(propertiesConfig.getEmailOtpSecretRandom(), objectMapper);
    }
