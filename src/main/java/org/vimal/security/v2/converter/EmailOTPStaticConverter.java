...
@Component
public class EmailOTPStaticConverter {
    private final AESStaticUtility aesStaticUtility;

    public EmailOTPStaticConverter(PropertiesConfig propertiesConfig,
                                   ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesStaticUtility = new AESStaticUtility(propertiesConfig.getEmailOtpSecretStatic(), objectMapper);
    }
