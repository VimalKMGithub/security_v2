...
@Component
public class EmailOTPToDeleteAccountRandomConverter {
    private final AESRandomUtility aesRandomUtility;

    public EmailOTPToDeleteAccountRandomConverter(PropertiesConfig propertiesConfig,
                                                  ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesRandomUtility = new AESRandomUtility(propertiesConfig.getEmailOtpToDeleteAccountSecretRandom(), objectMapper);
    }
