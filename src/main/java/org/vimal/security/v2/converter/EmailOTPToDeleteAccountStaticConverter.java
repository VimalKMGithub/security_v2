...
@Component
public class EmailOTPToDeleteAccountStaticConverter {
    private final AESStaticUtility aesStaticUtility;

    public EmailOTPToDeleteAccountStaticConverter(PropertiesConfig propertiesConfig,
                                                  ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesStaticUtility = new AESStaticUtility(propertiesConfig.getEmailOtpToDeleteAccountSecretStatic(), objectMapper);
    }
