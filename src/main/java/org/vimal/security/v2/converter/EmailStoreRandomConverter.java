...
@Component
public class EmailStoreRandomConverter {
    private final AESRandomUtility aesRandomUtility;

    public EmailStoreRandomConverter(PropertiesConfig propertiesConfig,
                                     ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesRandomUtility = new AESRandomUtility(propertiesConfig.getEmailStoreSecretRandom(), objectMapper);
    }
