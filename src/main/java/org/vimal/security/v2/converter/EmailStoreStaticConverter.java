...
@Component
public class EmailStoreStaticConverter {
    private final AESStaticUtility aesStaticUtility;

    public EmailStoreStaticConverter(PropertiesConfig propertiesConfig,
                                     ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesStaticUtility = new AESStaticUtility(propertiesConfig.getEmailStoreSecretStatic(), objectMapper);
    }
