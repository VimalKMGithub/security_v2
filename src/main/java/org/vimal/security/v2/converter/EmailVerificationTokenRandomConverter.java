...
@Component
public class EmailVerificationTokenRandomConverter {
    private final AESRandomUtility aesRandomUtility;

    public EmailVerificationTokenRandomConverter(PropertiesConfig propertiesConfig,
                                                 ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesRandomUtility = new AESRandomUtility(propertiesConfig.getEmailVerificationTokenSecretRandom(), objectMapper);
    }
