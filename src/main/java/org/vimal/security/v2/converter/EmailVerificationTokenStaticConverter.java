...
@Component
public class EmailVerificationTokenStaticConverter {
    private final AESStaticUtility aesStaticUtility;

    public EmailVerificationTokenStaticConverter(PropertiesConfig propertiesConfig,
                                                 ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesStaticUtility = new AESStaticUtility(propertiesConfig.getEmailVerificationTokenSecretStatic(), objectMapper);
    }
