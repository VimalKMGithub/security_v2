...
@Component
public class JWTRandomConverter {
    private final AESRandomUtility aesRandomUtility;

    public JWTRandomConverter(PropertiesConfig propertiesConfig,
                              ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesRandomUtility = new AESRandomUtility(propertiesConfig.getJwtSecretRandom(), objectMapper);
    }
