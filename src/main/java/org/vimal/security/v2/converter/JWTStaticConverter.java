...
@Component
public class JWTStaticConverter {
    private final AESStaticUtility aesStaticUtility;

    public JWTStaticConverter(PropertiesConfig propertiesConfig,
                              ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesStaticUtility = new AESStaticUtility(propertiesConfig.getJwtSecretStatic(), objectMapper);
    }
