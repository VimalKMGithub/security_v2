...
@Component
public class RefreshTokenRandomConverter {
    private final AESRandomUtility aesRandomUtility;

    public RefreshTokenRandomConverter(PropertiesConfig propertiesConfig,
                                       ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesRandomUtility = new AESRandomUtility(propertiesConfig.getRefreshTokenSecretRandom(), objectMapper);
    }
