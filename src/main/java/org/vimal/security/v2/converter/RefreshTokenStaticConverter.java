...
@Component
public class RefreshTokenStaticConverter {
    private final AESStaticUtility aesStaticUtility;

    public RefreshTokenStaticConverter(PropertiesConfig propertiesConfig,
                                       ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesStaticUtility = new AESStaticUtility(propertiesConfig.getRefreshTokenSecretStatic(), objectMapper);
    }
