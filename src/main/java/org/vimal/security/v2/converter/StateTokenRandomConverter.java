...
@Component
public class StateTokenRandomConverter {
    private final AESRandomUtility aesRandomUtility;

    public StateTokenRandomConverter(PropertiesConfig propertiesConfig,
                                     ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesRandomUtility = new AESRandomUtility(propertiesConfig.getStateTokenSecretRandom(), objectMapper);
    }
