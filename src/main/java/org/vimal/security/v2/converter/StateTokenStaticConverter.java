...
@Component
public class StateTokenStaticConverter {
    private final AESStaticUtility aesStaticUtility;

    public StateTokenStaticConverter(PropertiesConfig propertiesConfig,
                                     ObjectMapper objectMapper) throws NoSuchAlgorithmException {
        this.aesStaticUtility = new AESStaticUtility(propertiesConfig.getStateTokenSecretStatic(), objectMapper);
    }
